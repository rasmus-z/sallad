...
export const viMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Không có mô hình dự phòng",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Mô hình dự phòng",
      selectedFallbackFallback: "Mô hình dự phòng đã chọn",
      fallbackOff: "Tắt (không dự phòng)",
      fallbackModelHint: "Thử lại với mô hình này chỉ khi mô hình chính thất bại",
