...
export const viMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  advanced: {
    ...
    groupChats: {
      title: "Nhóm trò chuyện",
      description: "Chọn mô hình và cài đặt lấy mẫu dùng để chọn người nói tiếp theo trong nhóm trò chuyện.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Cài đặt này bị bỏ qua khi có ghi đè sampler cho Bộ nhớ động được đặt trong tab Tính năng của trình chỉnh sửa mô hình.",
  ...
  featureGeneration: {
    title: "Cài đặt tạo sinh",
    tabTitle: "Tính năng",
    tabDescription:
      "Cấu hình cách mỗi tính năng của ứng dụng lấy mẫu khi sử dụng mô hình này. Các trường chưa đặt sẽ kế thừa từ cài đặt tạo sinh của mô hình này.",
    features: {
      dynamicMemory: "Bộ nhớ động",
      companionSoulWriter: "Trình viết Companion Soul",
      companionMemory: "Bộ nhớ bạn đồng hành",
      lorebookEntryGenerator: "Lorebook Entry Generator",
      lorebookGenerator: "Lorebook Generator",
      sceneWriter: "Scene Writer",
      helpMeReply: "Giúp tôi trả lời",
      groupSpeakerSelection: "Chọn người nói trong nhóm",
      creationHelper: "Trợ lý tạo",
    },
    companionMemoryTitle: "Tạo bộ nhớ bạn đồng hành",
    description: "Ghi đè lấy mẫu cho tính năng này. Các trường chưa đặt sẽ kế thừa từ cấu hình mô hình.",
    reset: "Đặt lại ghi đè",
    modelDefault: "Mặc định của mô hình",
    featureDefaultHelper: "Mặc định của tính năng: {{value}}",
    inheritsHelper: "Kế thừa từ mô hình khi chưa đặt.",
    listHelper: "Phân tách bằng dấu phẩy. Để trống để kế thừa.",
    samplingSection: "Lấy mẫu",
    llamaSection: "Lấy mẫu llama.cpp",
    ollamaSection: "Lấy mẫu Ollama",
    temperature: "Nhiệt độ",
    topP: "Top P",
    topK: "Top K",
    ...
    minP: "Min P",
    typicalP: "Typical P",
    repeatPenalty: "Phạt lặp lại",
    penaltyRange: "Phạm vi phạt",
    xtcProbability: "Xác suất XTC",
    xtcThreshold: "Ngưỡng XTC",
  ...
  groupChatsSettings: {
    page: {
      info: "Nhóm trò chuyện sử dụng một lệnh gọi mô hình riêng để quyết định nhân vật nào sẽ nói tiếp theo. Chọn mô hình dùng cho việc chọn người nói tại đây. Ghi đè lấy mẫu nằm trong tab Tính năng của trình chỉnh sửa mô hình.",
    },
    sectionTitles: {
      speakerSelection: "Chọn người nói",
    },
    labels: {
      speakerModel: "Mô hình chọn người nói",
      speakerModelDescription: "Mô hình dùng để chọn người nói tiếp theo trong nhóm trò chuyện. Giữ mặc định của ứng dụng để dùng mô hình mặc định của bạn.",
      selectSpeakerModel: "Chọn mô hình chọn người nói",
      searchModels: "Tìm kiếm mô hình...",
      useAppDefault: "Dùng mặc định của ứng dụng{{model}}",
      useAppDefaultBase: "Dùng mặc định của ứng dụng",
      selectedModel: "Mô hình đã chọn",
      noModelsAvailable: "Không có mô hình nào. Hãy thêm mô hình trong Cài đặt trước.",
    },
  },
  samplerOrder: {
    title: "Thứ tự bộ lấy mẫu",
    description: "Thêm, xóa hoặc kéo các giai đoạn. Thực thi từ trên xuống dưới.",
    reset: "Đặt lại",
    resetAria: "Đặt lại thứ tự bộ lấy mẫu về mặc định",
    preset: "Cấu hình sẵn bộ lấy mẫu",
    builtInPresets: "Cấu hình sẵn tích hợp",
    customPresets: "Cấu hình sẵn tùy chỉnh",
    customChain: "Chuỗi tùy chỉnh",
    savePreset: "Lưu cấu hình sẵn",
    presetNamePlaceholder: "Tên cấu hình sẵn",
    presetSaved: "Đã lưu cấu hình sẵn của bộ lấy mẫu",
    presetSaveFailed: "Không thể lưu cấu hình sẵn của bộ lấy mẫu",
    deletePreset: "Xóa cấu hình sẵn {{name}}",
    presetDeleted: "Đã xóa cấu hình sẵn của bộ lấy mẫu",
    presetDeleteFailed: "Không thể xóa cấu hình sẵn của bộ lấy mẫu",
    activeStages: "Các giai đoạn đang hoạt động",
    emptyChain: "Không có giai đoạn lọc. Bước chọn token cuối vẫn được thực thi.",
    addSampler: "Thêm bộ lấy mẫu",
    removeSampler: "Xóa {{label}}",
    stages: {
      penalties: {
        label: "Phạt",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "Phạm vi phạt",
      penaltyRangeDescription: "Các token gần đây dùng cho phạt lặp lại, tần suất và hiện diện; `-1` dùng toàn bộ ngữ cảnh",
      xtcProbability: "Xác suất XTC",
      xtcThreshold: "Ngưỡng XTC",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP không khả dụng cho đầu vào hình ảnh",
      visionWarningDescription: "Yêu cầu hình ảnh sẽ tiếp tục mà không dùng MTP khi tệp vision MMProj đang được cấu hình.",
      placement: "Vị trí mô hình draft",
      placementDescription: "Tự động dùng GPU nhanh nhất còn đủ bộ nhớ",
      placementGpu: "GPU",
      placementCpu: "CPU",
