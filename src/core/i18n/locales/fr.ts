...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Aucun modèle de secours",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Modèle de secours",
      selectedFallbackFallback: "Modèle de secours sélectionné",
      fallbackOff: "Désactivé (aucun secours)",
      fallbackModelHint: "Réessayer avec ce modèle uniquement lorsque le modèle principal échoue",
      voiceTitle: "Voix",
      loadingVoices: "Chargement des voix...",
      customVoiceFallback: "Voix personnalisée",
      providerVoiceFallback: "Voix du fournisseur",
