...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Typical P",
      penaltyRange: "Fenêtre de pénalité",
      penaltyRangeDescription: "Tokens récents utilisés par les pénalités de répétition, fréquence et présence ; `-1` utilise tout le contexte",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP n’est pas disponible pour la vision",
      visionWarningDescription: "Les requêtes d’image continueront sans MTP tant qu’un fichier de vision MMProj est configuré.",
      placement: "Emplacement du modèle de brouillon",
      placementDescription: "Auto utilise le GPU le plus rapide disposant d’assez de mémoire",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Discussions de groupe",
      description: "Choisissez le modèle et les paramètres d'échantillonnage qui sélectionnent le prochain locuteur dans les discussions de groupe.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Ceci est ignoré lorsque des remplacements de sampler pour la Mémoire dynamique sont définis dans l'onglet Fonctionnalités de l'éditeur du modèle.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Fonctionnalités",
    tabDescription: "Configurez la façon dont chaque fonctionnalité de l'application échantillonne lorsqu'elle utilise ce modèle. Les champs non définis héritent des paramètres de génération de ce modèle.",
    features: {
      dynamicMemory: "Mémoire dynamique",
      companionSoulWriter: "Rédacteur d'âme du compagnon",
      companionMemory: "Mémoire du compagnon",
      lorebookEntryGenerator: "Générateur d'entrées de lorebook",
      lorebookGenerator: "Générateur de lorebook",
      sceneWriter: "Rédacteur de scène",
      helpMeReply: "Aidez-moi à répondre",
      groupSpeakerSelection: "Sélection du locuteur de groupe",
      creationHelper: "Assistant de création",
    },
    companionMemoryTitle: "Génération de mémoire du compagnon",
    description: "Remplacez l'échantillonnage pour cette fonctionnalité. Les champs non définis héritent de la configuration du modèle.",
    reset: "Réinitialiser les remplacements",
    modelDefault: "Défaut du modèle",
    featureDefaultHelper: "Défaut de la fonctionnalité : {{value}}",
    inheritsHelper: "Hérite du modèle lorsqu'il n'est pas défini.",
    listHelper: "Séparé par des virgules. Laissez vide pour hériter.",
    samplingSection: "Échantillonnage",
    llamaSection: "Échantillonnage llama.cpp",
    ollamaSection: "Échantillonnage Ollama",
    temperature: "Température",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Tokens de sortie max",
  ...
  groupChatsSettings: {
    page: {
      info: "Les discussions de groupe utilisent un appel de modèle dédié pour décider quel personnage parle ensuite. Choisissez ici le modèle utilisé pour la sélection du locuteur. Les remplacements d'échantillonnage se trouvent dans l'onglet Fonctionnalités de l'éditeur du modèle.",
    },
    sectionTitles: {
      speakerSelection: "Sélection du locuteur",
    },
    labels: {
      speakerModel: "Modèle de sélection du locuteur",
      speakerModelDescription: "Modèle utilisé pour choisir le prochain locuteur dans les discussions de groupe. Laissez sur le défaut de l'application pour utiliser votre modèle par défaut.",
      selectSpeakerModel: "Sélectionner le modèle de sélection du locuteur",
      searchModels: "Rechercher des modèles...",
      useAppDefault: "Utiliser le défaut de l'application{{model}}",
      useAppDefaultBase: "Utiliser le défaut de l'application",
      selectedModel: "Modèle sélectionné",
      noModelsAvailable: "Aucun modèle disponible. Ajoutez d'abord un modèle dans les Paramètres.",
    },
  },
  samplerOrder: {
    title: "Ordre du sampler",
    description: "Ajoutez, supprimez ou déplacez les étapes. Exécution de haut en bas.",
    reset: "Réinitialiser",
    resetAria: "Réinitialiser l'ordre du sampler par défaut",
    preset: "Préréglage du sampler",
    builtInPresets: "Préréglages intégrés",
    customPresets: "Préréglages personnalisés",
    customChain: "Chaîne personnalisée",
    savePreset: "Enregistrer le préréglage",
    presetNamePlaceholder: "Nom du préréglage",
    presetSaved: "Préréglage du sampler enregistré",
    presetSaveFailed: "Impossible d'enregistrer le préréglage du sampler",
    deletePreset: "Supprimer le préréglage {{name}}",
    presetDeleted: "Préréglage du sampler supprimé",
    presetDeleteFailed: "Impossible de supprimer le préréglage du sampler",
    activeStages: "Étapes actives",
    emptyChain: "Aucune étape de filtrage. La sélection finale du token est toujours exécutée.",
    addSampler: "Ajouter un sampler",
    removeSampler: "Supprimer {{label}}",
    stages: {
      penalties: {
        label: "Pénalités",
        desc: "Appliquer les pénalités de répétition, de fréquence et de présence avant le filtrage.",
      },
      grammar: {
        label: "Grammaire",
