...
export const ptMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    actions: {
      ...
      companionChanges: "Reação à sua mensagem",
  ...
  systemPrompts: {
    ...
    preview: {
      ...
      mock: {
        userLabel: "Mensagem do usuário nº {{n}}",
        userContent: "Esta é uma mensagem de exemplo do usuário nº {{n}}",
        assistantLabel: "Mensagem do assistente nº {{n}}",
        assistantContent: "Esta é uma mensagem de exemplo do assistente nº {{n}}",
      },
  ...
  advanced: {
    ...
    groupChats: {
      title: "Chats em Grupo",
      description: "Escolha qual modelo e quais configurações de sampling selecionam o próximo falante em chats em grupo.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Isto é ignorado quando substituições de sampler da Memória Dinâmica estão definidas na aba Recursos do editor de modelos.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Recursos",
    tabDescription: "Configure como cada recurso do app faz o sampling ao usar este modelo. Campos não definidos herdam das configurações de geração deste modelo.",
    features: {
      dynamicMemory: "Memória Dinâmica",
      companionSoulWriter: "Escritor de Companion Soul",
      companionMemory: "Memória do Companion",
      lorebookEntryGenerator: "Gerador de Entradas de Lorebook",
      lorebookGenerator: "Gerador de Lorebook",
      sceneWriter: "Redator de Cena",
      helpMeReply: "Me Ajude a Responder",
      groupSpeakerSelection: "Seleção de Falante do Grupo",
      creationHelper: "Assistente de Criação",
    },
    companionMemoryTitle: "Geração de Memória do Companion",
    description: "Sobrescreva o sampling para este recurso. Campos não definidos herdam da configuração do modelo.",
    reset: "Redefinir substituições",
    modelDefault: "Padrão do modelo",
    featureDefaultHelper: "Padrão do recurso: {{value}}",
    inheritsHelper: "Herda do modelo quando não definido.",
    listHelper: "Separado por vírgulas. Deixe vazio para herdar.",
  ...
  groupChatsSettings: {
    page: {
      info: "Chats em grupo usam uma chamada de modelo dedicada para decidir qual personagem fala em seguida. Escolha aqui o modelo usado para a seleção de falante. As substituições de sampling ficam na aba Recursos do editor de modelos.",
    },
    sectionTitles: {
      speakerSelection: "Seleção de Falante",
    },
    labels: {
      speakerModel: "Modelo de Seleção de Falante",
      speakerModelDescription: "Modelo usado para escolher o próximo falante em chats em grupo. Deixe no padrão do app para usar seu modelo padrão.",
      selectSpeakerModel: "Selecionar Modelo de Seleção de Falante",
      searchModels: "Pesquisar modelos...",
      useAppDefault: "Usar padrão do app{{model}}",
      useAppDefaultBase: "Usar padrão do app",
      selectedModel: "Modelo selecionado",
      noModelsAvailable: "Nenhum modelo disponível. Adicione um modelo nas Configurações primeiro.",
    },
  },
  samplerOrder: {
    ...
    preset: "Predefinição do sampler",
    builtInPresets: "Predefinições integradas",
    ...
    presetSaved: "Predefinição do sampler salva",
    presetSaveFailed: "Não foi possível salvar a predefinição do sampler",
    deletePreset: "Excluir predefinição {{name}}",
    presetDeleted: "Predefinição do sampler excluída",
    presetDeleteFailed: "Não foi possível excluir a predefinição do sampler",
    activeStages: "Etapas ativas",
    emptyChain: "Nenhuma etapa de filtragem. A seleção final de tokens ainda é executada.",
    addSampler: "Adicionar sampler",
    removeSampler: "Remover {{label}}",
    stages: {
      penalties: {
        label: "Penalidades",
        desc: "Aplicar penalidades de repetição, frequência e presença antes da filtragem.",
      },
      grammar: {
        label: "Gramática",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "Intervalo da penalidade",
      penaltyRangeDescription: "Tokens recentes usados pelas penalidades de repetição, frequência e presença; `-1` usa todo o contexto",
      xtcProbability: "Probabilidade XTC",
      xtcThreshold: "Limite XTC",
    ...
    mtp: {
      ...
      visionWarningTitle: "O MTP não está disponível para visão",
      visionWarningDescription: "As solicitações de imagem continuarão sem MTP enquanto houver um arquivo de visão MMProj configurado.",
      placement: "Alocação do modelo de rascunho",
      placementDescription: "Auto usa a GPU mais rápida que tenha espaço suficiente",
      placementGpu: "GPU",
      placementCpu: "CPU",
