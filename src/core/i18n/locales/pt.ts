...
export const ptMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Sem modelo de reserva",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Modelo de Reserva",
      selectedFallbackFallback: "Modelo de Reserva Selecionado",
      fallbackOff: "Desligado (sem reserva)",
      fallbackModelHint: "Tentar novamente com este modelo apenas quando o modelo principal falhar",
      voiceTitle: "Voz",
      ...
      selectFallbackModelTitle: "Selecionar Modelo de Reserva",
