...
export const itMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    actions: {
      ...
      companionChanges: "Reazione al tuo messaggio",
  ...
  systemPrompts: {
    ...
    preview: {
      ...
      mock: {
        userLabel: "Messaggio utente n. {{n}}",
        userContent: "Questo è un messaggio utente di esempio n. {{n}}",
        assistantLabel: "Messaggio assistente n. {{n}}",
        assistantContent: "Questo è un messaggio assistente di esempio n. {{n}}",
      },
  ...
  advanced: {
    ...
    groupChats: {
      title: "Chat di gruppo",
      description: "Scegli quale modello e quali impostazioni di campionamento selezionano il prossimo oratore nelle chat di gruppo.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Viene ignorato quando gli override del sampler per la Memoria dinamica sono impostati nella scheda Funzionalità dell'editor del modello.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Funzionalità",
    tabDescription: "Configura come ogni funzionalità dell'app campiona quando usa questo modello. I campi non impostati ereditano dalle impostazioni di generazione di questo modello.",
    features: {
      dynamicMemory: "Memoria dinamica",
      companionSoulWriter: "Companion Soul Writer",
      companionMemory: "Memoria del compagno",
      lorebookEntryGenerator: "Generatore voci lorebook",
      lorebookGenerator: "Generatore lorebook",
      sceneWriter: "Scrittore di scene",
      helpMeReply: "Aiutami a rispondere",
      groupSpeakerSelection: "Selezione oratore di gruppo",
      creationHelper: "Assistente alla creazione",
    },
    companionMemoryTitle: "Generazione memoria del compagno",
    description: "Sovrascrivi il campionamento per questa funzione. I campi non impostati ereditano dalla configurazione del modello.",
    reset: "Reimposta override",
    modelDefault: "Predefinito del modello",
    featureDefaultHelper: "Predefinito della funzione: {{value}}",
    inheritsHelper: "Eredita dal modello quando non impostato.",
    listHelper: "Separato da virgole. Lascia vuoto per ereditare.",
    samplingSection: "Campionamento",
    llamaSection: "Campionamento llama.cpp",
    ollamaSection: "Campionamento Ollama",
    temperature: "Temperatura",
    topP: "Top P",
    topK: "Top K",
    ...
    penaltyRange: "Intervallo penalità",
    xtcProbability: "Probabilità XTC",
    xtcThreshold: "Soglia XTC",
  ...
  groupChatsSettings: {
    page: {
      info: "Le chat di gruppo usano una chiamata al modello dedicata per decidere quale personaggio parla dopo. Scegli qui il modello usato per la selezione dell'oratore. Gli override di campionamento si trovano nella scheda Funzionalità dell'editor del modello.",
    },
    sectionTitles: {
      speakerSelection: "Selezione oratore",
    },
    labels: {
      speakerModel: "Modello di selezione oratore",
      speakerModelDescription: "Modello usato per scegliere il prossimo oratore nelle chat di gruppo. Lascia il predefinito dell'app per usare il tuo modello predefinito.",
      selectSpeakerModel: "Seleziona modello di selezione oratore",
      searchModels: "Cerca modelli...",
      useAppDefault: "Usa predefinito app{{model}}",
      useAppDefaultBase: "Usa predefinito app",
      selectedModel: "Modello selezionato",
      noModelsAvailable: "Nessun modello disponibile. Aggiungi prima un modello nelle Impostazioni.",
    },
  },
  samplerOrder: {
    title: "Ordine campionatore",
    description: "Aggiungi, rimuovi o trascina gli stadi. Eseguiti dall'alto verso il basso.",
    reset: "Reimposta",
    resetAria: "Reimposta l'ordine del campionatore ai valori predefiniti",
    preset: "Preimpostazione campionatore",
    builtInPresets: "Preimpostazioni integrate",
    customPresets: "Preimpostazioni personalizzate",
    customChain: "Catena personalizzata",
    savePreset: "Salva preimpostazione",
    presetNamePlaceholder: "Nome preimpostazione",
    presetSaved: "Preimpostazione del campionatore salvata",
    presetSaveFailed: "Impossibile salvare la preimpostazione del campionatore",
    deletePreset: "Elimina la preimpostazione {{name}}",
    presetDeleted: "Preimpostazione del campionatore eliminata",
    presetDeleteFailed: "Impossibile eliminare la preimpostazione del campionatore",
    activeStages: "Stadi attivi",
    emptyChain: "Nessuno stadio di filtraggio. La selezione finale dei token viene comunque eseguita.",
    addSampler: "Aggiungi campionatore",
    removeSampler: "Rimuovi {{label}}",
    stages: {
      penalties: {
        label: "Penalità",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "Intervallo penalità",
      penaltyRangeDescription: "Token recenti usati dalle penalità di ripetizione, frequenza e presenza; `-1` usa l'intero contesto",
      xtcProbability: "Probabilità XTC",
      xtcThreshold: "Soglia XTC",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP non è disponibile per la visione",
      visionWarningDescription: "Le richieste di immagini continueranno senza MTP finché è configurato un file di visione MMProj.",
      placement: "Posizionamento del modello di bozza",
      placementDescription: "Auto usa la GPU più veloce con spazio sufficiente",
      placementGpu: "GPU",
      placementCpu: "CPU",
