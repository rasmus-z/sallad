...
export const itMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Nessun modello di riserva",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Modello di riserva",
      selectedFallbackFallback: "Modello di riserva selezionato",
      fallbackOff: "Off (nessuna riserva)",
      fallbackModelHint: "Riprova con questo modello solo quando il modello principale fallisce",
      voiceTitle: "Voce",
      loadingVoices: "Caricamento voci...",
      customVoiceFallback: "Voce personalizzata",
