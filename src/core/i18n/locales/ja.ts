...
export const jaMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  advanced: {
    ...
    groupChats: {
      title: "グループチャット",
      description: "グループチャットで次の話者を選ぶモデルとサンプリング設定を選択します。",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "モデルエディターの「機能」タブでダイナミックメモリのサンプラーオーバーライドが設定されている場合、この設定は無視されます。",
  ...
  featureGeneration: {
    ...
    tabTitle: "機能",
    tabDescription:
      "このモデルを使用する各アプリ機能のサンプリング方法を設定します。未設定の項目はこのモデルの生成設定から継承されます。",
    features: {
      dynamicMemory: "ダイナミックメモリ",
      companionSoulWriter: "コンパニオンソウルライター",
      companionMemory: "コンパニオンメモリ",
      lorebookEntryGenerator: "ロアブックエントリー生成",
      lorebookGenerator: "ロアブック生成",
      sceneWriter: "シーンライター",
      helpMeReply: "返信アシスト",
      groupSpeakerSelection: "グループ話者選択",
      creationHelper: "作成ヘルパー",
    },
    companionMemoryTitle: "コンパニオンメモリ生成",
    description: "この機能のサンプリングを上書きします。未設定の項目はモデル設定から継承されます。",
    reset: "オーバーライドをリセット",
    modelDefault: "モデルのデフォルト",
    featureDefaultHelper: "機能のデフォルト: {{value}}",
    inheritsHelper: "未設定の場合はモデルから継承されます。",
    listHelper: "カンマ区切り。継承する場合は空欄のままにします。",
    samplingSection: "サンプリング",
    llamaSection: "llama.cpp サンプリング",
    ollamaSection: "Ollama サンプリング",
    temperature: "温度",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "最大出力トークン数",
  ...
  groupChatsSettings: {
    page: {
      info: "グループチャットでは、次に発言するキャラクターを決めるために専用のモデル呼び出しを使用します。話者選択に使用するモデルをここで選択します。サンプリングのオーバーライドはモデルエディターの「機能」タブにあります。",
    },
    sectionTitles: {
      speakerSelection: "話者選択",
    },
    labels: {
      speakerModel: "話者選択モデル",
      speakerModelDescription: "グループチャットで次の話者を選ぶために使用するモデルです。アプリのデフォルトのままにすると、デフォルトモデルが使用されます。",
      selectSpeakerModel: "話者選択モデルを選択",
      searchModels: "モデルを検索...",
      useAppDefault: "アプリのデフォルトを使用{{model}}",
      useAppDefaultBase: "アプリのデフォルトを使用",
      selectedModel: "選択中のモデル",
      noModelsAvailable: "利用可能なモデルがありません。まず設定でモデルを追加してください。",
    },
  },
  samplerOrder: {
    title: "サンプラー順序",
    description: "ステージを追加、削除、ドラッグできます。上から下に実行されます。",
    reset: "リセット",
    ...
    presetSaved: "サンプラープリセットを保存しました",
    presetSaveFailed: "サンプラープリセットを保存できませんでした",
    deletePreset: "プリセット「{{name}}」を削除",
    presetDeleted: "サンプラープリセットを削除しました",
    presetDeleteFailed: "サンプラープリセットを削除できませんでした",
    activeStages: "有効なステージ",
    emptyChain: "フィルタリングステージはありません。最終的なトークン選択は引き続き実行されます。",
    addSampler: "サンプラーを追加",
    removeSampler: "{{label}}を削除",
    stages: {
      penalties: {
        label: "ペナルティ",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "ペナルティ範囲",
      penaltyRangeDescription: "繰り返し・頻度・存在ペナルティに使う直近のトークン数。`-1` はコンテキスト全体を使用します",
      xtcProbability: "XTC 確率",
      xtcThreshold: "XTC しきい値",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP は画像入力では利用できません",
      visionWarningDescription: "MMProj ビジョンファイルが設定されている間、画像リクエストは MTP なしで続行されます。",
      placement: "ドラフトモデルの配置",
      placementDescription: "自動では、空き容量のある最速の GPU を使用します",
      placementGpu: "GPU",
      placementCpu: "CPU",
