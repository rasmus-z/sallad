...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Tidak ada model cadangan",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Model Cadangan",
      selectedFallbackFallback: "Model Cadangan Terpilih",
      fallbackOff: "Mati (tanpa cadangan)",
      fallbackModelHint: "Coba ulang dengan model ini hanya saat model utama gagal",
      voiceTitle: "Suara",
      loadingVoices: "Memuat suara...",
      customVoiceFallback: "Suara Kustom",
      providerVoiceFallback: "Suara Penyedia",
