...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  advanced: {
    ...
    groupChats: {
      title: "Obrolan Grup",
      description: "Pilih model dan pengaturan sampling mana yang memilih pembicara berikutnya dalam obrolan grup.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Ini diabaikan saat penggantian sampler Memori Dinamis diatur di tab Fitur pada editor model.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Fitur",
    tabDescription:
      "Konfigurasikan cara setiap fitur aplikasi melakukan sampling saat menggunakan model ini. Kolom yang kosong mewarisi dari pengaturan generasi model ini.",
    features: {
      dynamicMemory: "Memori Dinamis",
      companionSoulWriter: "Penulis Jiwa Companion",
      companionMemory: "Memori Companion",
      lorebookEntryGenerator: "Generator Entri Lorebook",
      lorebookGenerator: "Generator Lorebook",
      sceneWriter: "Penulis Adegan",
      helpMeReply: "Bantu Saya Balas",
      groupSpeakerSelection: "Pemilihan Pembicara Grup",
      creationHelper: "Asisten Pembuatan",
    },
    companionMemoryTitle: "Generasi Memori Companion",
    description: "Ganti pengaturan sampling untuk fitur ini. Kolom yang kosong mewarisi dari konfigurasi model.",
    reset: "Reset penggantian",
    modelDefault: "Bawaan model",
    featureDefaultHelper: "Bawaan fitur: {{value}}",
    inheritsHelper: "Mewarisi dari model saat tidak diatur.",
    listHelper: "Dipisahkan koma. Biarkan kosong untuk mewarisi.",
    samplingSection: "Sampling",
    llamaSection: "Sampling llama.cpp",
    ollamaSection: "Sampling Ollama",
    temperature: "Temperatur",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Token Output Maksimal",
  ...
  groupChatsSettings: {
    page: {
      info: "Obrolan grup menggunakan panggilan model khusus untuk menentukan karakter mana yang berbicara berikutnya. Pilih model yang digunakan untuk pemilihan pembicara di sini. Penggantian sampling ada di tab Fitur pada editor model.",
    },
    sectionTitles: {
      speakerSelection: "Pemilihan Pembicara",
    },
    labels: {
      speakerModel: "Model Pemilihan Pembicara",
      speakerModelDescription: "Model yang digunakan untuk memilih pembicara berikutnya dalam obrolan grup. Biarkan pada bawaan aplikasi untuk menggunakan model bawaan Anda.",
      selectSpeakerModel: "Pilih Model Pemilihan Pembicara",
      searchModels: "Cari model...",
      useAppDefault: "Gunakan bawaan aplikasi{{model}}",
      useAppDefaultBase: "Gunakan bawaan aplikasi",
      selectedModel: "Model terpilih",
      noModelsAvailable: "Tidak ada model tersedia. Tambahkan model di Pengaturan terlebih dahulu.",
    },
  },
  samplerOrder: {
    title: "Urutan Sampler",
    description: "Tambah, hapus, atau seret tahapan. Dieksekusi dari atas ke bawah.",
    reset: "Reset",
    resetAria: "Reset urutan sampler ke default",
    preset: "Preset sampler",
    builtInPresets: "Preset bawaan",
    customPresets: "Preset khusus",
    customChain: "Rantai khusus",
    savePreset: "Simpan preset",
    presetNamePlaceholder: "Nama preset",
    presetSaved: "Preset sampler disimpan",
    presetSaveFailed: "Preset sampler tidak dapat disimpan",
    deletePreset: "Hapus preset {{name}}",
    presetDeleted: "Preset sampler dihapus",
    presetDeleteFailed: "Preset sampler tidak dapat dihapus",
    activeStages: "Tahapan aktif",
    emptyChain: "Tidak ada tahapan penyaringan. Pemilihan token akhir tetap dijalankan.",
    addSampler: "Tambah sampler",
    removeSampler: "Hapus {{label}}",
    stages: {
      penalties: {
        label: "Penalti",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "Rentang penalti",
      penaltyRangeDescription: "Token terbaru untuk penalti pengulangan, frekuensi, dan kehadiran; `-1` memakai seluruh konteks",
      xtcProbability: "Probabilitas XTC",
      xtcThreshold: "Ambang XTC",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP tidak tersedia untuk vision",
      visionWarningDescription: "Permintaan gambar akan dilanjutkan tanpa MTP selama file vision MMProj dikonfigurasi.",
      placement: "Penempatan Model Draft",
      placementDescription: "Auto menggunakan GPU tercepat yang memiliki ruang cukup",
      placementGpu: "GPU",
      placementCpu: "CPU",
