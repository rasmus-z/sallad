...
export const ruMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Нет резервной модели",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Резервная модель",
      selectedFallbackFallback: "Выбранная резервная модель",
      fallbackOff: "Выкл. (без резерва)",
      fallbackModelHint: "Повторять с этой моделью только когда основная модель даёт сбой",
      voiceTitle: "Голос",
      loadingVoices: "Загрузка голосов...",
      ...
      selectFallbackModelTitle: "Выбрать резервную модель",
      searchModelsPlaceholder: "Поиск моделей...",
