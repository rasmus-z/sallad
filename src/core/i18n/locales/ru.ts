...
export const ruMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Typical P",
      penaltyRange: "Диапазон штрафа",
      penaltyRangeDescription: "Последние токены для штрафов за повторение, частоту и присутствие; `-1` использует весь контекст",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP недоступно для обработки изображений",
      visionWarningDescription: "Запросы с изображениями будут выполняться без MTP, пока настроен файл визуального проектора MMProj.",
      placement: "Размещение черновой модели",
      placementDescription: "Авто использует самый быстрый GPU с достаточным объёмом свободной памяти",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Групповые чаты",
      description: "Выберите, какая модель и какие настройки сэмплирования определяют следующего говорящего в групповых чатах.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Это игнорируется, если переопределения сэмплера для динамической памяти заданы на вкладке «Функции» в редакторе модели.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Функции",
    tabDescription: "Настройте, как каждая функция приложения выполняет сэмплирование при использовании этой модели. Незаданные поля наследуются от настроек генерации этой модели.",
    features: {
      dynamicMemory: "Динамическая память",
      companionSoulWriter: "Создатель души компаньона",
      companionMemory: "Память компаньона",
      lorebookEntryGenerator: "Генератор записей лорбука",
      lorebookGenerator: "Генератор лорбуков",
      sceneWriter: "Сценарист",
      helpMeReply: "Помоги ответить",
      groupSpeakerSelection: "Выбор говорящего в группе",
      creationHelper: "Помощник создания",
    },
    companionMemoryTitle: "Генерация памяти компаньона",
    description: "Переопределите сэмплирование для этой функции. Незаданные поля наследуются от конфигурации модели.",
    reset: "Сбросить переопределения",
    modelDefault: "Значение модели по умолчанию",
    featureDefaultHelper: "По умолчанию для функции: {{value}}",
    inheritsHelper: "Наследуется от модели, если не задано.",
    listHelper: "Через запятую. Оставьте пустым для наследования.",
    samplingSection: "Сэмплирование",
    llamaSection: "Сэмплирование llama.cpp",
    ollamaSection: "Сэмплирование Ollama",
    temperature: "Температура",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Макс. токенов вывода",
    ...
    minP: "Min P",
    typicalP: "Typical P",
    repeatPenalty: "Штраф за повторение",
    penaltyRange: "Диапазон штрафа",
    xtcProbability: "Вероятность XTC",
    xtcThreshold: "Порог XTC",
    dryMultiplier: "DRY Multiplier",
  ...
  groupChatsSettings: {
    page: {
      info: "Групповые чаты используют отдельный вызов модели, чтобы решить, какой персонаж говорит следующим. Выберите здесь модель, используемую для выбора говорящего. Переопределения сэмплирования находятся на вкладке «Функции» в редакторе модели.",
    },
    sectionTitles: {
      speakerSelection: "Выбор говорящего",
    },
    labels: {
      speakerModel: "Модель выбора говорящего",
      speakerModelDescription: "Модель, которая выбирает следующего говорящего в групповых чатах. Оставьте значение приложения по умолчанию, чтобы использовать вашу модель по умолчанию.",
      selectSpeakerModel: "Выбрать модель выбора говорящего",
      searchModels: "Поиск моделей...",
      useAppDefault: "Использовать модель по умолчанию{{model}}",
      useAppDefaultBase: "Использовать модель по умолчанию",
      selectedModel: "Выбранная модель",
      noModelsAvailable: "Нет доступных моделей. Сначала добавьте модель в настройках.",
    },
  },
  samplerOrder: {
    title: "Порядок сэмплера",
    description: "Добавляйте, удаляйте или перетаскивайте этапы. Выполняются сверху вниз.",
    reset: "Сбросить",
    resetAria: "Сбросить порядок сэмплера на значения по умолчанию",
    preset: "Предустановка сэмплера",
    builtInPresets: "Встроенные предустановки",
    customPresets: "Пользовательские предустановки",
    customChain: "Пользовательская цепочка",
    savePreset: "Сохранить предустановку",
    presetNamePlaceholder: "Название предустановки",
    presetSaved: "Предустановка сэмплера сохранена",
    presetSaveFailed: "Не удалось сохранить предустановку сэмплера",
    deletePreset: "Удалить предустановку {{name}}",
    presetDeleted: "Предустановка сэмплера удалена",
    presetDeleteFailed: "Не удалось удалить предустановку сэмплера",
    activeStages: "Активные этапы",
    emptyChain: "Этапы фильтрации отсутствуют. Финальный выбор токена по-прежнему выполняется.",
    addSampler: "Добавить сэмплер",
    removeSampler: "Удалить {{label}}",
    stages: {
      penalties: {
        label: "Штрафы",
