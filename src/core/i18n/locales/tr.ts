...
export const trMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Yedek model yok",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Yedek Model",
      selectedFallbackFallback: "Seçili Yedek Model",
      fallbackOff: "Kapalı (yedek yok)",
      fallbackModelHint: "Yalnızca birincil model başarısız olduğunda bu modelle tekrar deneyin",
      voiceTitle: "Ses",
      loadingVoices: "Sesler yükleniyor...",
      ...
      selectFallbackModelTitle: "Yedek Model Seçin",
      searchModelsPlaceholder: "Modelleri ara...",
