...
export const trMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Tipik P",
      penaltyRange: "Ceza aralığı",
      penaltyRangeDescription: "Tekrar, sıklık ve varlık cezalarında kullanılacak son tokenlar; `-1` tüm bağlamı kullanır",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP görsel girişlerde kullanılamaz",
      visionWarningDescription: "Bir MMProj görsel dosyası yapılandırıldığı sürece görsel istekleri MTP olmadan devam eder.",
      placement: "Taslak Model Yerleşimi",
      placementDescription: "Otomatik, yeterli alanı olan en hızlı GPU’yu kullanır",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Grup sohbetleri",
      description: "Grup sohbetlerinde sıradaki konuşmacıyı hangi modelin ve örnekleme ayarlarının seçeceğini belirle.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Model düzenleyicinin Özellikler sekmesinde Dinamik hafıza için örnekleyici geçersiz kılmaları ayarlıysa bu yoksayılır.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Özellikler",
    tabDescription: "Her uygulama özelliğinin bu modeli kullanırken nasıl örnekleme yapacağını yapılandırın. Ayarlanmayan alanlar bu modelin üretim ayarlarından devralınır.",
    features: {
      dynamicMemory: "Dinamik hafıza",
      companionSoulWriter: "Yoldaş ruh yazarı",
      companionMemory: "Yoldaş belleği",
      lorebookEntryGenerator: "Lorebook girdi oluşturucu",
      lorebookGenerator: "Lorebook oluşturucu",
      sceneWriter: "Sahne yazarı",
      helpMeReply: "Yanıtlamamda yardım et",
      groupSpeakerSelection: "Grup konuşmacı seçimi",
      creationHelper: "Oluşturma asistanı",
    },
    companionMemoryTitle: "Yoldaş Belleği Üretimi",
    description: "Bu özellik için örneklemeyi geçersiz kıl. Ayarlanmayan alanlar model yapılandırmasından devralınır.",
    reset: "Geçersiz kılmaları sıfırla",
    modelDefault: "Model varsayılanı",
    featureDefaultHelper: "Özellik varsayılanı: {{value}}",
    inheritsHelper: "Ayarlanmadığında modelden devralınır.",
    listHelper: "Virgülle ayrılmış. Devralmak için boş bırakın.",
    samplingSection: "Örnekleme",
    llamaSection: "llama.cpp Örneklemesi",
    ollamaSection: "Ollama Örneklemesi",
    temperature: "Sıcaklık",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Maksimum Çıkış Token'ı",
  ...
  groupChatsSettings: {
    page: {
      info: "Grup sohbetleri, sıradaki konuşacak karakteri belirlemek için ayrı bir model çağrısı kullanır. Konuşmacı seçiminde kullanılan modeli burada seçin. Örnekleme geçersiz kılmaları model düzenleyicinin Özellikler sekmesindedir.",
    },
    sectionTitles: {
      speakerSelection: "Konuşmacı Seçimi",
    },
    labels: {
      speakerModel: "Konuşmacı Seçim Modeli",
      speakerModelDescription: "Grup sohbetlerinde sıradaki konuşmacıyı seçen model. Varsayılan modelinizi kullanmak için uygulama varsayılanında bırakın.",
      selectSpeakerModel: "Konuşmacı Seçim Modelini Seç",
      searchModels: "Modellerde ara...",
      useAppDefault: "Uygulama varsayılanını kullan{{model}}",
      useAppDefaultBase: "Uygulama varsayılanını kullan",
      selectedModel: "Seçilen model",
      noModelsAvailable: "Kullanılabilir model yok. Önce Ayarlar'dan bir model ekleyin.",
    },
  },
  samplerOrder: {
    title: "Örnekleyici sırası",
    description: "Aşamaları ekle, kaldır veya sürükle. Yukarıdan aşağıya çalışır.",
    reset: "Sıfırla",
    resetAria: "Örnekleyici sırasını varsayılana sıfırla",
    preset: "Örnekleyici ön ayarı",
    builtInPresets: "Yerleşik ön ayarlar",
    customPresets: "Özel ön ayarlar",
    customChain: "Özel zincir",
    savePreset: "Ön ayarı kaydet",
    presetNamePlaceholder: "Ön ayar adı",
    presetSaved: "Örnekleyici ön ayarı kaydedildi",
    presetSaveFailed: "Örnekleyici ön ayarı kaydedilemedi",
    deletePreset: "{{name}} ön ayarını sil",
    presetDeleted: "Örnekleyici ön ayarı silindi",
    presetDeleteFailed: "Örnekleyici ön ayarı silinemedi",
    activeStages: "Etkin aşamalar",
    emptyChain: "Filtreleme aşaması yok. Son token seçimi yine de çalışır.",
    addSampler: "Örnekleyici ekle",
    removeSampler: "{{label}} öğesini kaldır",
    stages: {
      penalties: {
        label: "Cezalar",
