...
export const enMessages = {
  ...
  samplerOrder: {
    title: "Sampler Order",
    description: "Add, remove, or drag stages. Executed top to bottom.",
    reset: "Reset",
    ...
    presetSaved: "Sampler preset saved",
    presetSaveFailed: "Could not save sampler preset",
    deletePreset: "Delete {{name}} preset",
    presetDeleted: "Sampler preset deleted",
    presetDeleteFailed: "Could not delete sampler preset",
    activeStages: "Active stages",
    emptyChain: "No filtering stages. Final token selection still runs.",
    addSampler: "Add sampler",
    removeSampler: "Remove {{label}}",
    stages: {
      penalties: {
        label: "Penalties",
