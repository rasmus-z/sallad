...
export const plMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Brak modelu zapasowego",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Model zapasowy",
      selectedFallbackFallback: "Wybrany model zapasowy",
      fallbackOff: "Wył. (brak zapasowego)",
      fallbackModelHint: "Ponów próbę z tym modelem tylko, gdy główny model zawiedzie",
      voiceTitle: "Głos",
      loadingVoices: "Ładowanie głosów...",
      customVoiceFallback: "Niestandardowy głos",
      providerVoiceFallback: "Głos dostawcy",
