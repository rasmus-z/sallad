...
export const plMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  advanced: {
    ...
    groupChats: {
      title: "Czaty grupowe",
      description: "Wybierz, który model i które ustawienia próbkowania wybierają następnego mówcę w czatach grupowych.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Jest to ignorowane, gdy nadpisania samplera dla pamięci dynamicznej są ustawione w zakładce Funkcje w edytorze modelu.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Funkcje",
    tabDescription: "Skonfiguruj, jak każda funkcja aplikacji próbkuje, gdy używa tego modelu. Nieustawione pola dziedziczą z ustawień generowania tego modelu.",
    features: {
      dynamicMemory: "Pamięć dynamiczna",
      companionSoulWriter: "Twórca Companion Soul",
      companionMemory: "Pamięć towarzysza",
      lorebookEntryGenerator: "Lorebook Entry Generator",
      lorebookGenerator: "Generator Lorebooka",
      sceneWriter: "Scene Writer",
      helpMeReply: "Pomóż mi odpowiedzieć",
      groupSpeakerSelection: "Wybór mówcy w grupie",
      creationHelper: "Asystent tworzenia",
    },
    companionMemoryTitle: "Generowanie pamięci towarzysza",
    description: "Nadpisz próbkowanie dla tej funkcji. Nieustawione pola dziedziczą z konfiguracji modelu.",
    reset: "Resetuj nadpisania",
    modelDefault: "Domyślne modelu",
    featureDefaultHelper: "Domyślne funkcji: {{value}}",
    inheritsHelper: "Dziedziczy z modelu, gdy nieustawione.",
    listHelper: "Rozdzielone przecinkami. Pozostaw puste, aby dziedziczyć.",
    samplingSection: "Próbkowanie",
    llamaSection: "Próbkowanie llama.cpp",
    ollamaSection: "Próbkowanie Ollama",
    temperature: "Temperatura",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Maks. tokenów wyjściowych",
    frequencyPenalty: "Kara za częstotliwość",
    presencePenalty: "Kara za obecność",
    samplerProfile: "Profil samplera",
    minP: "Min P",
    ...
    stopSequences: "Sekwencje zatrzymujące",
  },
  groupChatsSettings: {
    page: {
      info: "Czaty grupowe używają dedykowanego wywołania modelu, aby zdecydować, która postać mówi jako następna. Wybierz tutaj model używany do wyboru mówcy. Nadpisania próbkowania znajdują się w zakładce Funkcje w edytorze modelu.",
    },
    sectionTitles: {
      speakerSelection: "Wybór mówcy",
    },
    labels: {
      speakerModel: "Model wyboru mówcy",
      speakerModelDescription: "Model używany do wybierania następnego mówcy w czatach grupowych. Pozostaw domyślny aplikacji, aby użyć swojego domyślnego modelu.",
      selectSpeakerModel: "Wybierz model wyboru mówcy",
      searchModels: "Szukaj modeli...",
      useAppDefault: "Użyj domyślnego aplikacji{{model}}",
      useAppDefaultBase: "Użyj domyślnego aplikacji",
      selectedModel: "Wybrany model",
      noModelsAvailable: "Brak dostępnych modeli. Najpierw dodaj model w Ustawieniach.",
    },
  },
  samplerOrder: {
    title: "Kolejność samplera",
    description: "Dodawaj, usuwaj lub przeciągaj etapy. Wykonywane od góry do dołu.",
    reset: "Resetuj",
    resetAria: "Resetuj kolejność samplera do domyślnej",
    preset: "Ustawienie samplera",
    builtInPresets: "Wbudowane ustawienia",
    customPresets: "Własne ustawienia",
    customChain: "Własny łańcuch",
    savePreset: "Zapisz ustawienie",
    presetNamePlaceholder: "Nazwa ustawienia",
    presetSaved: "Ustawienie samplera zapisane",
    presetSaveFailed: "Nie udało się zapisać ustawienia samplera",
    deletePreset: "Usuń ustawienie {{name}}",
    presetDeleted: "Ustawienie samplera usunięte",
    presetDeleteFailed: "Nie udało się usunąć ustawienia samplera",
    activeStages: "Aktywne etapy",
    emptyChain: "Brak etapów filtrowania. Końcowy wybór tokenu nadal jest wykonywany.",
    addSampler: "Dodaj sampler",
    removeSampler: "Usuń {{label}}",
    stages: {
      penalties: {
        label: "Kary",
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      typicalP: "Typical P",
      penaltyRange: "Zakres kary",
      penaltyRangeDescription: "Ostatnie tokeny dla kar za powtórzenia, częstotliwość i obecność; `-1` używa całego kontekstu",
      xtcProbability: "Prawdopodobieństwo XTC",
      xtcThreshold: "Próg XTC",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP nie jest dostępne dla obrazu",
      visionWarningDescription: "Żądania obrazów będą kontynuowane bez MTP, dopóki skonfigurowany jest plik wizyjny MMProj.",
      placement: "Umiejscowienie modelu szkicu",
      placementDescription: "Tryb Auto używa najszybszego GPU z wystarczającą ilością wolnej pamięci",
      placementGpu: "GPU",
      placementCpu: "CPU",
