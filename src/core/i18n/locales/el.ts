...
export const elMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Κανένα μοντέλο εφεδρείας",
    },
    search: {
    ...
    widgets: {
      ...
      selector: {
        ...
        searchModels: "Αναζήτηση μοντέλων...",
        noFallbackModel: "Χωρίς εναλλακτικό μοντέλο",
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Μοντέλο Υποτίπου (Fallback)",
      selectedFallbackFallback: "Επιλεγμένο Μοντέλο Υποτίπου",
      fallbackOff: "Απενεργοποιημένο (χωρίς υποτίπο)",
      fallbackModelHint: "Δοκιμή ξανά με αυτό το μοντέλο μόνο όταν αποτύχει το κύριο μοντέλο",
      voiceTitle: "Φωνή",
      loadingVoices: "Φόρτωση φωνών...",
      customVoiceFallback: "Προσαρμοσμένη Φωνή",
      providerVoiceFallback: "Φωνή Παρόχου",
      ...
      selectModelTitle: "Επιλογή Μοντέλου",
      selectFallbackModelTitle: "Επιλογή Μοντέλου Υποτίπου",
      searchModelsPlaceholder: "Αναζήτηση μοντέλων...",
      selectVoiceTitle: "Επιλογή Φωνής",
      searchVoicesPlaceholder: "Αναζήτηση φωνών...",
      myVoices: "Οι Φωνές Μου",
