...
export const elMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Typical P",
      penaltyRange: "Εύρος ποινής",
      penaltyRangeDescription: "Πρόσφατα tokens για ποινές επανάληψης, συχνότητας και παρουσίας· το `-1` χρησιμοποιεί όλο το πλαίσιο",
    ...
    mtp: {
      ...
      visionWarningTitle: "Το MTP δεν είναι διαθέσιμο για όραση",
      visionWarningDescription: "Τα αιτήματα εικόνας θα συνεχίζονται χωρίς MTP όσο έχει ρυθμιστεί αρχείο όρασης MMProj.",
      placement: "Τοποθέτηση μοντέλου προσχεδίου",
      placementDescription: "Η Αυτόματη επιλογή χρησιμοποιεί την ταχύτερη GPU με διαθέσιμο χώρο",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Ομαδικές Συνομιλίες",
      description: "Επιλέξτε ποιο μοντέλο και ποιες ρυθμίσεις δειγματοληψίας επιλέγουν τον επόμενο ομιλητή στις ομαδικές συνομιλίες.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Αυτό αγνοείται όταν έχουν οριστεί αντικαταστάσεις sampler για τη Δυναμική Μνήμη στην καρτέλα Λειτουργίες του επεξεργαστή μοντέλου.",
  ...
  featureGeneration: {
    title: "Ρυθμίσεις Δημιουργίας",
    tabTitle: "Λειτουργίες",
    tabDescription: "Ρυθμίστε πώς κάνει δειγματοληψία κάθε λειτουργία της εφαρμογής όταν χρησιμοποιεί αυτό το μοντέλο. Τα μη ορισμένα πεδία κληρονομούνται από τις ρυθμίσεις δημιουργίας αυτού του μοντέλου.",
    features: {
      dynamicMemory: "Δυναμική Μνήμη",
      companionSoulWriter: "Συγγραφέας Ψυχής Συντρόφου",
      companionMemory: "Μνήμη Συντρόφου",
      lorebookEntryGenerator: "Γεννήτρια Καταχωρήσεων Βιβλίου Γνώσης",
      lorebookGenerator: "Δημιουργός Lorebook",
      sceneWriter: "Συγγραφέας Σκηνών",
      helpMeReply: "Βοήθησέ με να Απαντήσω",
      groupSpeakerSelection: "Επιλογή Ομιλητή Ομάδας",
      creationHelper: "Βοηθός Δημιουργίας",
    },
    companionMemoryTitle: "Δημιουργία Μνήμης Συντρόφου",
    description: "Αντικαταστήστε τη δειγματοληψία για αυτή τη λειτουργία. Τα μη ορισμένα πεδία κληρονομούνται από τη διαμόρφωση του μοντέλου.",
    reset: "Επαναφορά αντικαταστάσεων",
    modelDefault: "Προεπιλογή μοντέλου",
    featureDefaultHelper: "Προεπιλογή λειτουργίας: {{value}}",
    inheritsHelper: "Κληρονομείται από το μοντέλο όταν δεν έχει οριστεί.",
    listHelper: "Διαχωρισμένα με κόμματα. Αφήστε κενό για κληρονόμηση.",
    samplingSection: "Δειγματοληψία",
    llamaSection: "Δειγματοληψία llama.cpp",
    ollamaSection: "Δειγματοληψία Ollama",
    temperature: "Θερμοκρασία",
    topP: "Top P",
    topK: "Top K",
    maxOutputTokens: "Μέγιστα Tokens Εξόδου",
  ...
  groupChatsSettings: {
    page: {
      info: "Οι ομαδικές συνομιλίες χρησιμοποιούν μια ξεχωριστή κλήση μοντέλου για να αποφασίσουν ποιος χαρακτήρας θα μιλήσει στη συνέχεια. Επιλέξτε εδώ το μοντέλο που χρησιμοποιείται για την επιλογή ομιλητή. Οι αντικαταστάσεις δειγματοληψίας βρίσκονται στην καρτέλα Λειτουργίες του επεξεργαστή μοντέλου.",
    },
    sectionTitles: {
      speakerSelection: "Επιλογή Ομιλητή",
    },
    labels: {
      speakerModel: "Μοντέλο Επιλογής Ομιλητή",
      speakerModelDescription: "Το μοντέλο που επιλέγει τον επόμενο ομιλητή στις ομαδικές συνομιλίες. Αφήστε το στην προεπιλογή της εφαρμογής για να χρησιμοποιείται το προεπιλεγμένο σας μοντέλο.",
      selectSpeakerModel: "Επιλογή Μοντέλου Επιλογής Ομιλητή",
      searchModels: "Αναζήτηση μοντέλων...",
      useAppDefault: "Χρήση προεπιλογής εφαρμογής{{model}}",
      useAppDefaultBase: "Χρήση προεπιλογής εφαρμογής",
      selectedModel: "Επιλεγμένο μοντέλο",
      noModelsAvailable: "Δεν υπάρχουν διαθέσιμα μοντέλα. Προσθέστε πρώτα ένα μοντέλο στις Ρυθμίσεις.",
    },
  },
  samplerOrder: {
    title: "Σειρά Δειγματολήπτη",
    description: "Προσθέστε, αφαιρέστε ή σύρετε στάδια. Εκτελούνται από πάνω προς τα κάτω.",
    reset: "Επαναφορά",
    resetAria: "Επαναφορά σειράς δειγματολήπτη στις προεπιλογές",
    preset: "Προρύθμιση δειγματολήπτη",
    builtInPresets: "Ενσωματωμένες προρυθμίσεις",
    customPresets: "Προσαρμοσμένες προρυθμίσεις",
    customChain: "Προσαρμοσμένη αλυσίδα",
    savePreset: "Αποθήκευση προρύθμισης",
    presetNamePlaceholder: "Όνομα προρύθμισης",
    presetSaved: "Η προρύθμιση δειγματολήπτη αποθηκεύτηκε",
    presetSaveFailed: "Δεν ήταν δυνατή η αποθήκευση της προρύθμισης δειγματολήπτη",
    deletePreset: "Διαγραφή προρύθμισης {{name}}",
    presetDeleted: "Η προρύθμιση δειγματολήπτη διαγράφηκε",
    presetDeleteFailed: "Δεν ήταν δυνατή η διαγραφή της προρύθμισης δειγματολήπτη",
    activeStages: "Ενεργά στάδια",
    emptyChain: "Δεν υπάρχουν στάδια φιλτραρίσματος. Η τελική επιλογή token εξακολουθεί να εκτελείται.",
    addSampler: "Προσθήκη δειγματολήπτη",
    removeSampler: "Αφαίρεση {{label}}",
    stages: {
      penalties: {
        label: "Ποινές",
