...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Walang fallback model",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Fallback na Model",
      selectedFallbackFallback: "Napiling Fallback Model",
      fallbackOff: "Naka-off (walang fallback)",
      fallbackModelHint: "Subukang muli gamit ang model na ito kapag nabigo lang ang pangunahing model",
      voiceTitle: "Boses",
