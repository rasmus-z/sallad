...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Typical P",
      penaltyRange: "Saklaw ng penalty",
      penaltyRangeDescription: "Mga kamakailang token para sa repeat, frequency, at presence penalty; ginagamit ng `-1` ang buong context",
    ...
    mtp: {
      ...
      visionWarningTitle: "Hindi available ang MTP para sa vision",
      visionWarningDescription: "Magpapatuloy ang mga image request nang walang MTP habang may naka-configure na MMProj vision file.",
      placement: "Placement ng Draft Model",
      placementDescription: "Ginagamit ng Auto ang pinakamabilis na GPU na may sapat na espasyo",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Mga Group Chat",
      description: "Piliin kung aling model at mga setting ng sampling ang pipili ng susunod na speaker sa mga group chat.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Hindi ito pinapansin kapag may nakatakdang sampler override para sa Dynamic Memory sa tab na Mga Feature ng model editor.",
  ...
  featureGeneration: {
    title: "Mga Setting ng Generation",
    tabTitle: "Mga Feature",
    tabDescription:
      "I-configure kung paano nagsa-sample ang bawat feature ng app kapag ginagamit nito ang model na ito. Ang mga field na walang nakatakda ay nagmamana mula sa mga setting ng generation ng model na ito.",
    features: {
      dynamicMemory: "Dynamic Memory",
      companionSoulWriter: "Tagasulat ng Companion Soul",
      companionMemory: "Companion Memory",
      lorebookEntryGenerator: "Generator ng Lorebook Entry",
      lorebookGenerator: "Generator ng Lorebook",
      sceneWriter: "Tagasulat ng Eksena",
      helpMeReply: "Tulungan Akong Sumagot",
      groupSpeakerSelection: "Pagpili ng Speaker ng Grupo",
      creationHelper: "Katulong sa Paggawa",
    },
    companionMemoryTitle: "Pag-generate ng Companion Memory",
    description: "I-override ang sampling para sa feature na ito. Ang mga field na walang nakatakda ay nagmamana mula sa configuration ng model.",
    reset: "I-reset ang mga override",
    modelDefault: "Default ng model",
    featureDefaultHelper: "Default ng feature: {{value}}",
    inheritsHelper: "Nagmamana mula sa model kapag walang nakatakda.",
    listHelper: "Pinaghihiwalay ng comma. Iwanang blangko para magmana.",
  ...
  groupChatsSettings: {
    page: {
      info: "Gumagamit ang mga group chat ng dedicated na model call para magdesisyon kung aling karakter ang susunod na magsasalita. Piliin dito ang model na ginagamit para sa pagpili ng speaker. Ang mga sampling override ay nasa tab na Mga Feature ng model editor.",
    },
    sectionTitles: {
      speakerSelection: "Pagpili ng Speaker",
    },
    labels: {
      speakerModel: "Model para sa Pagpili ng Speaker",
      speakerModelDescription: "Model na ginagamit para piliin ang susunod na speaker sa mga group chat. Iwanan sa app default para gamitin ang iyong default na modelo.",
      selectSpeakerModel: "Pumili ng Model para sa Pagpili ng Speaker",
      searchModels: "Maghanap ng mga modelo...",
      useAppDefault: "Gamitin ang app default{{model}}",
      useAppDefaultBase: "Gamitin ang app default",
      selectedModel: "Napiling modelo",
      noModelsAvailable: "Walang available na modelo. Magdagdag muna ng modelo sa Settings.",
    },
  },
  samplerOrder: {
    title: "Pagkakasunod-sunod ng Sampler",
    description: "Magdagdag, mag-alis, o mag-drag ng mga stage. Ine-execute mula taas pababa.",
    reset: "I-reset",
    resetAria: "I-reset ang sampler order sa default",
    preset: "Preset ng sampler",
    builtInPresets: "Mga built-in na preset",
    customPresets: "Mga custom na preset",
    customChain: "Custom na chain",
    savePreset: "I-save ang preset",
    presetNamePlaceholder: "Pangalan ng preset",
    presetSaved: "Na-save ang preset ng sampler",
    presetSaveFailed: "Hindi ma-save ang preset ng sampler",
    deletePreset: "I-delete ang preset na {{name}}",
    presetDeleted: "Na-delete ang preset ng sampler",
    presetDeleteFailed: "Hindi ma-delete ang preset ng sampler",
    activeStages: "Mga aktibong stage",
    emptyChain: "Walang filtering stage. Patuloy pa ring tatakbo ang huling pagpili ng token.",
    addSampler: "Magdagdag ng sampler",
    removeSampler: "Alisin ang {{label}}",
    stages: {
      penalties: {
        label: "Mga Parusa",
