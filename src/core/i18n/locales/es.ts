...
export const esMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settings: {
      ...
      noFallbackModel: "Sin modelo de respaldo",
    },
    search: {
  ...
  characters: {
    ...
    edit: {
      ...
      fallbackModelTitle: "Modelo de respaldo",
      selectedFallbackFallback: "Modelo de respaldo seleccionado",
      fallbackOff: "Desactivado (sin respaldo)",
      fallbackModelHint: "Reintentar con este modelo solo cuando falle el modelo principal",
      voiceTitle: "Voz",
      loadingVoices: "Cargando voces...",
      customVoiceFallback: "Voz personalizada",
      providerVoiceFallback: "Voz del proveedor",
