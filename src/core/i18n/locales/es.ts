...
export const esMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  editModel: {
    ...
    llamaSampler: {
      ...
      minP: "Min P",
      typicalP: "Typical P",
      penaltyRange: "Rango de penalización",
      penaltyRangeDescription: "Tokens recientes usados por las penalizaciones de repetición, frecuencia y presencia; `-1` usa todo el contexto",
    ...
    mtp: {
      ...
      visionWarningTitle: "MTP no está disponible para visión",
      visionWarningDescription: "Las solicitudes de imágenes continuarán sin MTP mientras haya un archivo de visión MMProj configurado.",
      placement: "Ubicación del modelo de borrador",
      placementDescription: "Auto usa la GPU más rápida que tenga espacio disponible",
      placementGpu: "GPU",
      placementCpu: "CPU",
  ...
  advanced: {
    ...
    groupChats: {
      title: "Chats grupales",
      description: "Elige qué modelo y qué ajustes de muestreo eligen al siguiente hablante en los chats grupales.",
    },
    usageAnalytics: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      overwriteSamplerGenerationSettingsNote: "Esto se ignora cuando hay anulaciones del muestreador de Memoria dinámica definidas en la pestaña Funciones del editor de modelos.",
  ...
  featureGeneration: {
    ...
    tabTitle: "Funciones",
    tabDescription: "Configura cómo muestrea cada función de la app cuando usa este modelo. Los campos sin definir heredan de los ajustes de generación de este modelo.",
    features: {
      dynamicMemory: "Memoria dinámica",
      companionSoulWriter: "Escritor de alma del compañero",
      companionMemory: "Memoria del compañero",
      lorebookEntryGenerator: "Generador de entradas de lorebook",
      lorebookGenerator: "Generador de lorebook",
      sceneWriter: "Escritor de escenas",
      helpMeReply: "Ayúdame a responder",
      groupSpeakerSelection: "Selección de hablante en grupo",
      creationHelper: "Asistente de creación",
    },
    companionMemoryTitle: "Generación de memoria del compañero",
    description: "Anula el muestreo para esta función. Los campos sin definir heredan de la configuración del modelo.",
    reset: "Restablecer anulaciones",
    modelDefault: "Predeterminado del modelo",
    featureDefaultHelper: "Predeterminado de la función: {{value}}",
    inheritsHelper: "Hereda del modelo cuando no está definido.",
    listHelper: "Separado por comas. Deja vacío para heredar.",
  ...
  groupChatsSettings: {
    page: {
      info: "Los chats grupales usan una llamada de modelo dedicada para decidir qué personaje habla a continuación. Elige aquí el modelo usado para la selección de hablante. Las anulaciones de muestreo se encuentran en la pestaña Funciones del editor de modelos.",
    },
    sectionTitles: {
      speakerSelection: "Selección de hablante",
    },
    labels: {
      speakerModel: "Modelo de selección de hablante",
      speakerModelDescription: "Modelo usado para elegir al siguiente hablante en los chats grupales. Déjalo en el predeterminado de la app para usar tu modelo predeterminado.",
      selectSpeakerModel: "Seleccionar modelo de selección de hablante",
      searchModels: "Buscar modelos...",
      useAppDefault: "Usar el predeterminado de la app{{model}}",
      useAppDefaultBase: "Usar el predeterminado de la app",
      selectedModel: "Modelo seleccionado",
      noModelsAvailable: "No hay modelos disponibles. Añade primero un modelo en Ajustes.",
    },
  },
  samplerOrder: {
    title: "Orden del muestreador",
    description: "Añade, elimina o arrastra etapas. Se ejecutan de arriba a abajo.",
    reset: "Restablecer",
    ...
    emptyChain: "No hay etapas de filtrado. La selección final de tokens sigue ejecutándose.",
    addSampler: "Añadir muestreador",
