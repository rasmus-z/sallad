...
pub(crate) fn prepare_feature_request(
    provider_id: &str,
    session: &Session,
    model: &Model,
    settings: &Settings,
    ...
    request_settings.reasoning_enabled = false;
    request_settings.reasoning_effort = None;
    request_settings.reasoning_budget = None;
